            ...
            <div class="span3">
                <div class="sidebar">
                    ...
                    <ul class="widget widget-menu unstyled">
                        ...
                        <li><a id="recommend"><i class="menu-icon icon-bold"></i> 志愿推荐 </a></li>
                    </ul>
                </div>
                <!--/.sidebar-->
            </div>
            ...
            <div class="span9" style="width: 1470px">
                <div class="content">
                    ...
                    <form class="navbar-search pull-left input-append" action="#" style="float: right;">
                        ...
                        <div id = "recommendBar" class="form-group" style="margin-top: 20px;margin-bottom:  10px;margin-left:  10px;float: left;display: block;;display:none ">
                            <input style="height: 30px;width:  80px;margin-right:  10px" type="text" class="span3" id="subInput1" placeholder="数学成绩">
                            <input style="height: 30px;width:  80px;margin-right:  10px" type="text" class="span3" id="subInput2" placeholder="外语成绩">
                            <input style="height: 30px;width:  80px;margin-right:  10px" type="text" class="span3" id="subInput3" placeholder="语文成绩">

                            <select class="selectpicker" id="subSelect1" name="subSelect"
                            ...
                            <input style="height: 30px;width:  100px;" type="text" class="span3" id="xksubInput1" placeholder="选考科目1成绩">

                            <select class="selectpicker" id="subSelect2" name="subSelect"
                                    data-width="100%" style="width: 60px;margin-right:  10px">
                                <optgroup label="类别">
                                    <option>物理</option>
                                    <option>化学</option>
                            ...
                            <input style="height: 30px;width:  100px;" type="text" class="span3" id="xksubInput2" placeholder="选考科目2成绩">

                            <select class="selectpicker" id="subSelect3" name="subSelect"
                                    data-width="100%" style="width:  60px;margin-right:  10px">
                                <optgroup label="类别">
                                    <option>物理</option>
                                    <option>化学</option>
                            ...
                            <input style="height: 30px;width:  100px;" type="text" class="span3" id="xksubInput3" placeholder="选考科目3成绩">
                            <button class="btn" style="margin-left: 10px;" type="button" id="recommendBtn">
                                推荐志愿
                            </button>
                        </div>
                    </form>
...
<script src="../scripts/js/admin/recommend.js" type="text/javascript"></script>
